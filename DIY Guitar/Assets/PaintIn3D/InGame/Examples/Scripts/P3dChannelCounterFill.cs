...
namespace PaintIn3D.Examples
{
    ...
    public class P3dChannelCounterFill : MonoBehaviour
    {
        ...
        public List<P3dChannelCounter> Counters { get { if (counters == null) counters = new List<P3dChannelCounter>(); return counters; } }
        ...
        protected virtual void Update()
        {
            ...
            cachedImage.fillAmount = Mathf.Clamp01(ratio) / fillBarScaler;
        }
    }
}
